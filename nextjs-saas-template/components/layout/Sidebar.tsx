...
export default function Sidebar() {
  ...
  return (
    <aside className="flex w-64 flex-col bg-[#080810] border-r border-white/[0.06]">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
        <p className="px-2 pb-2 text-[10px] font-semibold uppercase tracking-widest text-white/20">
          Navigation
        </p>
      ...
      <div className="shrink-0 border-t border-white/[0.06] px-4 py-4">
        <div className="rounded-lg bg-white/[0.03] px-3 py-3 ring-1 ring-white/[0.06]">
          <div className="flex items-center justify-between">
            <p className="text-xs font-medium text-white/40">Plan actuel</p>
            <span className="rounded-full bg-white/[0.08] px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-white/60">
              Pro
            </span>
          </div>
          <div className="mt-2">
            ...
            <div className="h-1 w-full overflow-hidden rounded-full bg-white/[0.06]">
              <div className="h-full w-[42%] rounded-full bg-white/40" />
            </div>
          </div>
        </div>
      </div>
