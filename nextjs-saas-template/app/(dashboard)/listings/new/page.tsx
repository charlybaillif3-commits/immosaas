...
/**
 * app/(dashboard)/listings/new/page.tsx — Page de génération IA
 *
 * Server Component : pas de "use client".
 * GeneratorForm est un Client Component qui gère tout l'état interactif.
 */
        ...
        <div className="flex items-start gap-3">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-indigo-500/15">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.75}
              className="w-4 h-4 text-indigo-400" aria-hidden>
